...
　
  ...
  While details are provided in Section 8, Reference [1], the program can compute time evolution equations for any number of elements 
...
1. File Structure
  ...
  1.1. binomial_v017.py (Main Program)
  ...
  These codes were developed using Spyder IDE 5.4.3 on Ubuntu 22.04.2 LTS as of March 2024. 
...
2. Folder Preparation
  ...
  and store your input files there (refer to Figure 1 in Readme_v017_Figuers.pdf). 
...
3.5. binomial_parameter_06.json
  ...
  If "NO" is selected, no files will be generated.
    ...
    "InformationCalc": ["YES" or "NO"], Calculates the amount of information and its cumulative value, and outputs it to a CSV file.
                                        (For detailed definitions, refer to section 8 in the literature [1])
    ...
    "Optimization":     ["YES" or "NO"], Not set
