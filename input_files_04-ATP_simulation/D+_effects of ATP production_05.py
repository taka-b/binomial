...
datasets = [
    {
        "label": "DHO:: = 1.34×10^8",
        "ATP_D": np.array([375921, 169188,	30534, 558, 63, 0], dtype=float),
        "ATP_H": np.array([227718636, 227896407, 228037920, 	228093738, 228110883, 228121668 ], dtype=float),
        "marker": "o",
        "linestyle": "-",
    },
    {
        "label": "DHO:: = 1.34×10^7",
        "ATP_D": np.array([36942, 16584, 3009, 60, 6, 0], dtype=float),
        "ATP_H": np.array([228073623, 228091716, 228106602,	228123774, 228129141, 228125733], dtype=float),
        "marker": "s",
        "linestyle": "-",
    },
    {
        "label": "DHO:: = 1.34×10^6",
        "ATP_D": np.array([2580, 1182, 186, 3, 0, 0], dtype=float),
        "ATP_H": np.array([228121632, 228113115, 228129582,	228124674, 228119697, 228110061], dtype=float),
        "marker": "^",
        "linestyle": "-",
    },
]
