...
File structuer
 ...
 This program uses four python files and one input file as shown below.
    ...
    3. reaction.py
        Classes in the file define several reaction schemes depend on the elements.
         Reading a input file sets elements and a reaction type.
    4. utility.py
...
Getting started
      ...
      Locate five files in one folder and run the main program, nns.py. Calculation start, and Plots appeare. 
      Test codes were run by Spyder 4.1.5. Below is a explanation of a input file, inp_004_04.txt.

      Another example file, inp_Glycolysis_05_05.txt is avalable.
      You can exchane input files to write line 21 in nns.py.
    ...
    2. Element
         ...
         The name, initial number, color for plotting are necessary. 
         Total element numbers needs in the first line.
    ...
    3. Reaction
        ...
        There are five types of the reaction as below.
              ...
              r1_3 : One element type separate three kind of element type.
              r2_1 : Two element types become one elementtype
              r2_2 : Two element types change anothor two element types.
              r3_1 : Three element types become one element type.
      ...
      those reactions. 
          ...
          *Reaction, 13, 1000000
           ...
           r1_1, 004, 1, dendricMHC, 0.002, 1, dendricCell
           ...
           r2_1, 001, 1, virus, 1, cell, 0.01, 1, virusCell
           r2_1, 002, 1, virus, 1, dendricCell, 0.15, 1, dendricMHC
           r2_1, 003, 1, macrophageActive, 1, virus, 100.0, 1, macrophageWithVirus
           r2_1, 004, 1, macrophage, 2, IFN, 2.0, 1, macrophageActive
           r2_2, 001, 1, naiveTh1, 1, dendricMHC, 2.3, 1, activeTh1, 1, dendricMHC
          *Reaction End
